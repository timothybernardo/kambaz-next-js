/**
 * Quiz Editor with two tabs: Details and Questions.
 * Details tab edits every quiz setting (title, description, quiz type,
 * options, dates). Questions tab adds/edits/deletes questions via an
 * inline QuestionEditor subcomponent that handles Multiple Choice,
 * True/False, and Fill in the Blank. Total points auto-calculated from
 * the sum of question points on save.
 */
...
export default function QuizEditorPage() {
  ...
  const updateQuestion = (idx: number, updated: Question) =>
    setQuiz((q) => ({
      ...q,
      questions: q.questions.map((qu, i) => (i === idx ? updated : qu)),
    }));
  ...
  return (
    <div id="wd-quiz-editor">
      ...
      {/* ── Tabs ── */}
      <ul
        className="nav nav-tabs px-3 pt-2 sticky-top bg-white"
              ...
              <div className="border rounded p-3 mt-2">
                  ...
                  {quiz.timeLimit > 0 && (
                    <>
                      <FormControl
                        ...
                        onChange={(e) =>
                          set("timeLimit", Number(e.target.value))
                        }
                      />
                      <span>Minutes</span>
                    </>
                ...
                <div className="mt-2">
                  <FormCheck
                    ...
                    onChange={(e) =>
                      set("accessCode", e.target.checked ? "pass" : "")
                    }
                  />
                  {quiz.accessCode && (
                    <FormControl
      ...
      <div className="d-flex justify-content-end gap-2 px-4 pb-4">
        ...
        <button className="btn btn-danger" onClick={handleSavePublish}>
          Save & Publish
        </button>
      </div>
    </div>
            ...
            {question.choices?.map((choice, ci) => (
              ...
              >
                <span
                  style={{
                    width: 24,
                    color: choice.isCorrect ? "green" : "transparent",
                    fontSize: 20,
                  }}
                >
                  ➤
            ...
            {[true, false].map((val) => (
              ...
              >
                <span
                  style={{
                    color:
                      question.correctAnswer === val ? "green" : "transparent",
                    fontSize: 20,
                  }}
                >
                  ➤
                ...
                <span
                  className={
                    question.correctAnswer === val ? "text-success fw-bold" : ""
                  }
                >
                  {val ? "True" : "False"}
                </span>
