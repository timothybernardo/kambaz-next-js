/**
 * Faculty-only preview of what a quiz looks like to students.
 * Scoring is local only — no backend attempt record is created, so
 * faculty can test their quiz without polluting real attempt data.
 * Supports both all-questions-at-once and one-at-a-time display modes,
 * with green/red borders and correct-answer highlights after submit.
 */
