/**
 * All axios calls to the Express backend for quizzes, centralized here.
 * Every request hits /api/... with withCredentials so the session cookie
 * is sent along. Covers quiz CRUD, publish toggle, and student attempts
 * (submit + fetch my attempts).
 */
