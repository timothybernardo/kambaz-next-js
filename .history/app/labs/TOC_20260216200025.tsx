...
export default function TOC() {
 ...
 return (
   <Nav variant="pills">
     ...
     <NavItem>
       <NavItem>
       <NavLink href="/labs/lab3" as={Link} className={`nav-link ${pathname.endsWith("lab4") ? "active" : ""}`}>
         Lab 4 </NavLink> </NavItem>
     <NavItem></NavItem>
       <NavLink href="/" as={Link}>
         Kambaz </NavLink> </NavItem>
     <NavItem>
       <NavLink href="https://github.com/timothybernardo">My GitHub</NavLink></NavItem>
   </Nav>
 );}
