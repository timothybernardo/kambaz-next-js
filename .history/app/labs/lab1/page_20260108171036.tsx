"use client";
// used to convert button into client component
  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-matcha-recipe">
          <li>Sift 1-2 teaspoons of matcha powder into a bowl.</li>
          <li>Add 2 tablespoons of hot water.</li>
          <li>Whisk vigorously with a bamboo whisk until smooth.</li>
          <li>Heat 8 oz of any kind of milk until steaming.</li>
          <li>Pour 1.5 cups of any kind of milk into a glass of ice.</li>
          <li>Pour the matcha on top of the glass.</li>
          <li>Sweeten to taste with honey or agave syrup if desired.</li>
        </ol>
...
p2.jpg"
      ...
      <br />
      Please
      <a href = "https://github.com/timothybernardo/kanbas-next-js" id="wd-github">click here</a>
      for GitHub link<br/>
    </div>
  );
}
